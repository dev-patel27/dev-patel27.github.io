...
!(function (a, b) {
	...
	n.extend({
		...
		hasData: function (a) {
			return (
				!!(a = a.nodeType ? n.cache[a[n.expando]] : a[n.expando]) && !P(a)
			);
		},
		data: function (a, b, c) {
			return Q(a, b, c);
		...
		l.submit ||
			(n.event.special.submit = {
				setup: function () {
					...
					n.event.add(this, 'click._submit keypress._submit', function (
						a
					) {
						var b = a.target,
							c =
					...
					if (ja.test(this.nodeName))
						return (
							('checkbox' !== this.type && 'radio' !== this.type) ||
								(n.event.add(this, 'propertychange._change', function (
									a
								) {
	...
	function Ga(a, b, c, d) {
		...
		if (
			...
			if (h)
				for (
					j = i[i.length - 1].ownerDocument, n.map(i, Da), m = 0;
					m < h;
					m++
				)
					(g = i[m]),
		...
		c.queue ||
			...
			1 === a.nodeType &&
				...
				'inline' ===
					(k =
						'none' === j
							? n._data(a, 'olddisplay') || La(a.nodeName)
							: j) &&
					'none' === n.css(a, 'float') &&
	...
	n.fn.extend({
				...
				if (3 !== f && 8 !== f && 2 !== f)
					return void 0 === a.getAttribute
						...
						: ((1 === f && n.isXMLDoc(a)) ||
								...
								(e =
									n.attrHooks[b] ||
									(n.expr.match.bool.test(b) ? tb : sb))),
						  void 0 !== c
								? null === c
		...
		n.each(n.expr.match.bool.source.match(/\w+/g), function (a, b) {
			...
			(xb && wb) || !vb.test(b)
				...
				: (ub[b] = function (a, b, c) {
						if (!c)
							return a[n.camelCase('default-' + b)]
								? b.toLowerCase()
								: null;
				  });
		}),
	...
	(n.offset = {
		...
		n.each(['top', 'left'], function (a, b) {
			n.cssHooks[b] = Ta(l.pixelPosition, function (a, c) {
				if (c)
					return (
						(c = Ra(a, b)), Na.test(c) ? n(a).position()[b] + 'px' : c
					);
			});
		}),
...
(function (jQuery, window, undefined) {
	...
	function migrateWarnProp(obj, prop, value, msg) {
		...
		jQuery._definePropertyBroken = !0;
		obj[prop] = value;
	}
