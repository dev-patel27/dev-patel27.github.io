			...
			},
			{
				...
				run: function () {
					for (
						...
						(d = f[c - 1] || 0),
							(e =
								this._widths[this.relative(c)] + this.settings.margin),
							f.push(d + e * a);
					this._coordinates = f;
				},
			},
			...
			function (t, e, n) {
				...
				function r(t, e) {
					...
					(o.containerWidth = null),
						...
						(o.scrollbarXBottom = s.toInt(
							c.css(o.scrollbarXRail, 'bottom')
						)),
						...
						(o.scrollbarYRight = s.toInt(
							c.css(o.scrollbarYRail, 'right')
						)),
...
!(function (a) {
	'function' == typeof define && define.amd
		...
		? (module.exports = a(require('jquery'), window.Modernizr))
	...
	return (
				...
				return (
					B || 'width' !== c
						? B ||
						  'height' !== c ||
						  (e +=
								E._getFloat(d.paddingTop) +
								E._getFloat(d.paddingBottom) +
								E._getFloat(d.borderTopWidth) +
								E._getFloat(d.borderBottomWidth))
						: (e +=
								E._getFloat(d.paddingLeft) +
								E._getFloat(d.paddingRight) +
								E._getFloat(d.borderLeftWidth) +
								E._getFloat(d.borderRightWidth)),
					e
				);
			}
		...
		(E.prototype._toggleFilterClasses = function (a, b) {
			a.removeClass(E.ClassName.CONCEALED).addClass(E.ClassName.FILTERED),
				b.removeClass(E.ClassName.FILTERED).addClass(E.ClassName.CONCEALED);
		}),
		(E.prototype._initItems = function (a) {
			(a = a || this.$items),
				a.addClass(
					[E.ClassName.SHUFFLE_ITEM, E.ClassName.FILTERED].join(' ')
				),
				a.css(this.itemCss).data('point', new A()).data('scale', x);
		}),
		...
		(E.prototype._setSequentialDelay = function (a) {
			this.supported &&
				f(
					...
					function (a, b) {
						a.style[m] =
							'0ms,' + (b + 1) * this.sequentialFadeDelay + 'ms';
					},
					this
				);
		}),
		...
		(E.prototype._getColumnSize = function (b, c) {
			...
			return (
				(d = a.isFunction(this.columnWidth)
					? this.columnWidth(b)
					: this.useSizer
					? E._getOuterWidth(this.sizer)
					: this.columnWidth
					? this.columnWidth
					: this.$items.length > 0
					? E._getOuterWidth(this.$items[0], !0)
					: b),
				0 === d && (d = b),
				d + c
			);
		...
		(E.prototype._getGutterSize = function (b) {
			...
			return (c = a.isFunction(this.gutterWidth)
				? this.gutterWidth(b)
				: this.useSizer
				? E._getNumberStyle(this.sizer, 'marginLeft')
				: this.gutterWidth);
		}),
		(E.prototype._setColumns = function (a) {
			var b = a || E._getOuterWidth(this.element),
				...
				e = (b + c) / d;
			Math.abs(Math.round(e) - e) < this.columnThreshold &&
				(e = Math.round(e)),
		...
		(E.prototype._getItemPosition = function (a) {
			for (
				var b = this._getColumnSpan(a.width, this.colWidth, this.cols),
					...
					e = new A(Math.round(this.colWidth * d), Math.round(c[d])),
					f = c[d] + a.height,
		...
		(E.prototype._getColumnSpan = function (a, b, c) {
			var d = a / b;
			return (
				Math.abs(Math.round(d) - d) < this.columnThreshold &&
					(d = Math.round(d)),
		...
		(E.prototype._getStylesForTransition = function (a) {
			...
			return (
				this.supported
					? (b[p] = E._getItemTransformString(a.point, a.scale))
		...
		(E.prototype._startItemAnimation = function (b, c, d, e) {
			function f(b) {
				b.target === b.currentTarget &&
					(a(b.target).off(o, f), g._removeTransitionReference(h), e());
			}
			var g = this,
				h = { $element: b, handler: f };
		...
		(E.prototype._processStyleQueue = function (b) {
			...
			f(
				...
				c.length > 0 && this.initialized && this.speed > 0
		...
		(E.prototype._cancelMovement = function () {
			this.supported
				? f(this._transitions, function (a) {
						a.$element.off(o, a.handler);
				  })
				: ((this._isMovementCanceled = !0),
				  this.$items.stop(!0),
				  (this._isMovementCanceled = !1)),
		...
		(E.prototype._whenCollectionDone = function (b, c, d) {
			function e(b) {
				b.target === b.currentTarget &&
					(a(b.target).off(c, e),
					f++,
					f === g && (h._removeTransitionReference(i), d.call(h)));
			}
			var f = 0,
				g = b.length,
				h = this,
				i = { $element: b, handler: e };
			...
			a.when.apply(null, this._animations).always(
				a.proxy(function () {
					(this._animations.length = 0),
						this._isMovementCanceled || b.call(this);
				}, this)
			);
		}),
		...
		(E.prototype.remove = function (b) {
			function c() {
				b.remove(),
					(this.$items = this._getItems()),
					this._updateItemCount(),
					this._fire(E.EventType.REMOVED, [b, this]),
					(b = null);
			}
			b.length &&
				b.jquery &&
				...
				this._shrink(b),
				this.sort(),
				this.$el.one(E.EventType.LAYOUT + '.' + u, a.proxy(c, this)));
		}),
		(E.prototype.destroy = function () {
			D.off('.' + this.unique),
				this.$el.removeClass(u).removeAttr('style').removeData(u),
				this.$items
					.removeAttr('style')
					.removeData('point')
					.removeData('scale')
					.removeClass(
						[
							E.ClassName.CONCEALED,
							E.ClassName.FILTERED,
							E.ClassName.SHUFFLE_ITEM,
						].join(' ')
					),
				(this.$items = null),
				(this.$el = null),
...
var PageTransitions = (function ($, options) {
	...
	function init(options) {
		...
		$('.lmpixels-arrow-right').click(function () {
			var activeItem = $('.main-menu a.active').closest(
	...
	function Animate($pageTrigger, gotoPage) {
		...
		switch (selectedAnimNumber) {
			...
			case 13:
				inClass = 'animated-section-moveFromRight';
				outClass =
					'animated-section-moveToLeftEasing animated-section-ontop';
				break;
			case 14:
				inClass = 'animated-section-moveFromLeft';
				outClass =
					'animated-section-moveToRightEasing animated-section-ontop';
				break;
			case 15:
				inClass = 'animated-section-moveFromBottom';
				outClass =
					'animated-section-moveToTopEasing animated-section-ontop';
				break;
			case 16:
				inClass = 'animated-section-moveFromTop';
				outClass =
					'animated-section-moveToBottomEasing animated-section-ontop';
				break;
			case 17:
				inClass = 'animated-section-moveFromRight animated-section-ontop';
			...
			case 54:
				...
				outClass =
					'animated-section-rotateRoomLeftOut animated-section-ontop';
				break;
			case 55:
				inClass = 'animated-section-rotateRoomRightIn';
				outClass =
					'animated-section-rotateRoomRightOut animated-section-ontop';
				break;
			case 56:
				inClass = 'animated-section-rotateRoomTopIn';
				outClass =
					'animated-section-rotateRoomTopOut animated-section-ontop';
				break;
			case 57:
			...
			case 58:
				...
				outClass =
					'animated-section-rotateCubeLeftOut animated-section-ontop';
				break;
			case 59:
				inClass = 'animated-section-rotateCubeRightIn';
				outClass =
					'animated-section-rotateCubeRightOut animated-section-ontop';
				break;
			case 60:
				inClass = 'animated-section-rotateCubeTopIn';
				outClass =
					'animated-section-rotateCubeTopOut animated-section-ontop';
				break;
			case 61:
	...
	mutate_event_stack = [
		{
			...
			handler: function (a) {
				var e = t(a);
				return (
					e.data('mutate-width') || e.data('mutate-width', e.width()),
					e.data('mutate-width') && e.width() != e.data('mutate-width')
						? (e.data('mutate-width', e.width()), !0)
						: !1
				);
			},
		},
		{
			...
			handler: function (a) {
				var e = t(a);
				return (
					e.data('mutate-height') || e.data('mutate-height', e.height()),
					e.data('mutate-height') && e.height() != e.data('mutate-height')
						? (e.data('mutate-height', e.height()), !0)
						: void 0
				);
			},
		},
		{
			...
			handler: function (a) {
				var e = t(a);
				return (
					e.data('mutate-top') || e.data('mutate-top', e.css('top')),
					e.data('mutate-top') && e.css('top') != e.data('mutate-top')
						? (e.data('mutate-top', e.css('top')), !0)
						: void 0
				);
			},
		},
			...
			handler: function (a) {
				...
				return (
					...
					e.css('bottom') != e.data('mutate-bottom')
						? (e.data('mutate-bottom', e.css('bottom')), !0)
						: void 0
				);
			},
		},
		{
			...
			handler: function (a) {
				var e = t(a);
				return (
					e.data('mutate-right') || e.data('mutate-right', e.css('right')),
					e.data('mutate-right') &&
					e.css('right') != e.data('mutate-right')
						? (e.data('mutate-right', e.css('right')), !0)
						: void 0
				);
			},
		},
		{
			...
			handler: function (a) {
				var e = t(a);
				return (
					e.data('mutate-left') || e.data('mutate-left', e.css('left')),
					e.data('mutate-left') && e.css('left') != e.data('mutate-left')
						? (e.data('mutate-left', e.css('left')), !0)
						: void 0
				);
			},
		},
		...
		},
		{
			...
			handler: function (a) {
				var e = t(a),
					r = e.is(':visible'),
					d =
						void 0 == e.data('prev-visible') ? r : e.data('prev-visible');
			...
			handler: function (a) {
				...
				return (
					...
					e[0].scrollHeight != e.data('prev-scrollHeight')
						? (e.data('prev-scrollHeight', e[0].scrollHeight), !0)
						: void 0
				);
			},
		},
			...
			handler: function (a) {
				...
				return (
					...
					e[0].scrollWidth != e.data('prev-scrollWidth')
						? (e.data('prev-scrollWidth', e[0].scrollWidth), !0)
						: void 0
				);
			},
		},
			...
			handler: function (a) {
				...
				return (
					...
					e[0].scrollTop() != e.data('prev-scrollTop')
						? (e.data('prev-scrollTop', e[0].scrollTop()), !0)
						: void 0
				);
			},
		},
			...
			handler: function (a) {
				...
				return (
					...
					e[0].scrollLeft() != e.data('prev-scrollLeft')
						? (e.data('prev-scrollLeft', e[0].scrollLeft()), !0)
						: void 0
				);
			},
		},
	...
	function reset() {
		...
		$.each(parent.stack, function (i, n) {
			$(n.selector).each(function (a, b) {
				if (parent.events[n.event_name](b) === !0) {
...
(function ($) {
	...
	$(document).on('ready', function () {
		...
		lazyVideo();
		$('.section-content, .content-wrapper').mutate('height', function (
			element,
			info
		) {
			updateScroll();
...
var ajaxurl =
	'https://lmpixels.com/wp/breezycv-wp-lin/dark/wp-admin/admin-ajax.php';
